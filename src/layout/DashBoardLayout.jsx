...
import { MdOutlineDirectionsBike, MdOutlineTaskAlt } from 'react-icons/md';
        ...
        <div className="drawer lg:drawer-open ">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <Link to="/dashboard" className="px-4">Zaf Shift Dashboard</Link>
                </nav>
                {/* Page content here */}
                <Outlet></Outlet>
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        {/* approve Riders */}
                        {
                            role === 'rider' && <>
                                <li>
                                    <NavLink to="/dashboard/assign-deliveries"
                        ...
                        }
                        {
                            role === 'admin' && <>
                                <li>
                                    <NavLink to="/dashboard/approveRiders" className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Approved Riders">
